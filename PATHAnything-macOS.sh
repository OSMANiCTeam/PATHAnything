# OSMANiC PATHAnything for macOS Copyright 2022
# Version 1.0.1
...
# As of Jun 4 2022, this software is untested, as we are unable to obtain a Mac for testing, https://github.com/OSMANiCTeam/PATHAnything/discussions/1
...
echo
clear
FILE=/usr/local/bin/$command_name
if [ -f "$FILE" ]; then
    echo "Successfully added $command_name to PATH"
    echo You can remove your script by typing "sudo rm /usr/local/bin/$command_name"
else
